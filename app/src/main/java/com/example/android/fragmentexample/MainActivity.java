...
public class MainActivity extends AppCompatActivity {
    ...
    public void displayFragment() {
        ...
        SimpleFragment simpleFragments = SimpleFragment.newInstance();
        ...
        fragmentTransaction.add(R.id.fragment_container, (Fragment) simpleFragments).addToBackStack(null).commit();
